...
public class User {
  ...
  public User(Integer id, String firstName, String lastName, String emailAcademic, String password, Role role,
      String officeNumber, String speciality, String department, Boolean isActive) {
    this.id = id;
